...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nionui-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8856&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nionui-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nionui` can be installed with:

```
conda install nionui
```

It is possible to list all of the versions of `nionui` available on your platform with:
